...
## Learning Objectives
- Understand how to replicate a background image scroll effect application which is a simple app that shows how to apply background image scroll effect that enhances user interface and interesting user experience.

## Description of the Project
For the first milestone in the process of creating Background image scroll effect, you will:
